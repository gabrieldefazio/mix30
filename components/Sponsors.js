  ...
  return (
    <View style={styles.sponsors}>
      ...
      <Text style={styles.description}>
        We love the sponsors for this festival. They make all of this possible, and we couldn’t have done it without them.
      </Text>

      {/*<Text style={styles.sponsorTierTitle}>Platinum Sponsors</Text>*/}
      <View style={styles.sponsorTier}>
        <Sponsor
          url={'https://www.nys.gov/'}
          image={Images.nyc}
        />
      </View>
      <View style={styles.sponsorTier}>
        <Sponsor
          url={'https://http://www.arts.ny.gov/'}
          image={Images.coa}
        />
      </View>
