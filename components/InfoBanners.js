...
export class TwitterBanner extends React.PureComponent {
    ...
    return (
      <View style={twitterStyles.container}>
        <TouchableOpacity onPress={this._tweetWithHashtag}>
          <Text style={twitterStyles.heading}>#mix30</Text>
        </TouchableOpacity>
        <Text style={twitterStyles.description}>
          Tell everyone about MIX by tweeting, posting, or whatever it is you
          do with the hashtag&nbsp;
  ...
  _tweetWithHashtag = async () => {
    const appURL = 'twitter://post?hashtags=mix30';
    const webURL = 'https://twitter.com/intent/tweet?hashtags=mix30';
    try {
